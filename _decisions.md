...
- **Status**: código implementado y verificado local (typecheck web+collab 0/0 · unit 100/100 · RLS viejas 30/30 contra prod · build limpio). Migraciones (6 ficheros `2026-07-12_*.sql`) y deploys (hour-collab → hour-web) pendientes del gate de permisos de producción — ver `_tasks.md § Dispatch`.
