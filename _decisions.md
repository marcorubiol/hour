...
- **Status**: la parte de **nav** de este ADR está superada por **ADR-057** (forma final). Lo propio de ADR-056 (line detail = composición de módulos) sigue **pendiente de construir**.
