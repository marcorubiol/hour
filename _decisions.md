...
## [2026-07-04] — ADR-055 · Line detail = composición de módulos; plantillas de line (el kind se vuelve preset)
...
- **Status**: Decidido + **implementado** 2026-07-04 (nav). El resto del rediseño (line detail como composición de módulos) sigue pendiente.
